 ...
 * performed instead.
 */
public final class MySelectionEngine extends Engine implements ISearchRequestor {
		...
		ProblemReporter problemReporter =
			...
			public CategorizedProblem createProblem(
				...
				CategorizedProblem pb =  super.createProblem(
					...
					lineNumber,
					columnNumber);
					if(MySelectionEngine.this.problem == null && pb.isError() && (pb.getID() & IProblem.Syntax) == 0) {
						MySelectionEngine.this.problem = pb;
					}
	 ...
	 * local.
	 */
	private boolean isLocal(TypeBinding binding) {
