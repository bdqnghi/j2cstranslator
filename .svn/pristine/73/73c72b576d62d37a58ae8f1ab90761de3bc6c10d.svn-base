...
public class CheckMappingFilesAction extends ActionDelegate implements
	 ...
	 */
	public CheckMappingFilesAction() {
		super();
	}
	...
	public void translate(IJavaProject javaProject) {
		try {
			...
			checkMappingFiles(javaProject, globalOptions);
	...
	private static void checkMappingFiles(IJavaProject javaProject,
