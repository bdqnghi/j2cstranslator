...
namespace IBM.ICU.Impl {
	...
	/// <summary>
	/// A utility class providing proleptic Gregorian calendar functions used by time
	/// zone and calendar code. Do not instantiate.
	/// Note: Unlike GregorianCalendar, all computations performed by this class
	/// occur in the pure proleptic GregorianCalendar.
	/// </summary>
	///
	public class Grego {
	
	    // Max/min milliseconds
	    public const long MIN_MILLIS = -184303902528000000L;
	
	    public const long MAX_MILLIS = 183882168921600000L;
	    ...
	    public const int MILLIS_PER_DAY = 24 * MILLIS_PER_HOUR;
	    ...
	    private static readonly int[] MONTH_LENGTH = new int[] { 31, 28, 31, 30, 31,
	            30, 31, 31, 30, 31, 30, 31, 31, 29, 31, 30, 31, 30, 31, 31, 30, 31,
	            30, 31 };
	
	    private static readonly int[] DAYS_BEFORE = new int[] { 0, 31, 59, 90, 120,
	            151, 181, 212, 243, 273, 304, 334, 0, 31, 60, 91, 121, 152, 182,
	            213, 244, 274, 305, 335 };
	    ...
	    /// <param name="year">Gregorian year, with 0 == 1 BCE, -1 == 2 BCE, etc.</param>
	    /// <param name="month">0-based month, with 0==Jan</param>
	    /// <param name="dom">1-based day of month</param>
	    /// <returns>the day number, with day 0 == Jan 1 1970</returns>
	    public static long FieldsToDay(int year, int month, int dom) {
	        int y = year - 1;
	        long julian = 365 * y + FloorDivide(y, 4) + (JULIAN_1_CE - 3) + // Julian
	                                                                        // cal
	                FloorDivide(y, 400) - FloorDivide(y, 100) + 2 + // => Gregorian
	                                                                // cal
	    ...
	    public static int DayOfWeek(long day) {
	        ...
	        FloorDivide(day + IBM.ICU.Util.Calendar.THURSDAY, 7, remainder);
	    ...
	    public static int[] DayToFields(long day, int[] fields) {
	        ...
	        int month = (12 * (dayOfYear + correction) + 6) / 367; // zero-based
	                                                               // month
	     ...
	     * 
	     * result[0] : year result[1] : month result[2] : dayOfMonth result[3] :
	     * dayOfWeek result[4] : dayOfYear result[5] : millisecond in day
	     */
	    public static int[] TimeToFields(long time, int[] fields) {
	        ...
	        long[] remainder = new long[1];
	        long day = FloorDivide(time,
	                24 * 60 * 60 * 1000 /* milliseconds per day */, remainder);
