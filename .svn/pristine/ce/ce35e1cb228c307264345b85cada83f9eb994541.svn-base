...
public interface ITransformer {
	...
	public abstract boolean applyChange(IProgressMonitor pm)
	...
	public abstract void postAction(ICompilationUnit icunit,
			CompilationUnit unit);
	
	public abstract void setTriggerConditionName(String optionName);

	public abstract void postActionOnAST(ICompilationUnit icunit,
			CompilationUnit unit);
