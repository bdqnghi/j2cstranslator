...
// --------------------------------------------------------------------------------------------------
 namespace ILOG.J2CsMapping.RegEx {
	...
	/// </summary>
	///
	/// <seealso cref="T:ILOG.J2CsMapping.RegEx.LeafSet"/>
	internal class ReluctantQuantifierSet : LeafQuantifierSet {
	
		public ReluctantQuantifierSet(LeafSet innerSet, AbstractSet next, int type) : base(innerSet, next, type) {
		}
