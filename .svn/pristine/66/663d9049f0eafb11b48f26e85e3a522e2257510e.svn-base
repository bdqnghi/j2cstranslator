...
public class TargetField extends TargetMemberElement {
	...
	// <target name="..." isRemoved="" renamed="" type="">
	//    <modifiers ... />
	//    <pattern>
	//      <CDATA>...</CDATA>
	//    </pattern>
	...
	private boolean needTargetPart() {
		return !pattern.isDefaultValue() || getChangeModifierDescriptor() != null || 
				!type.isDefaultValue() || !comments.isDefaultValue();
	}
