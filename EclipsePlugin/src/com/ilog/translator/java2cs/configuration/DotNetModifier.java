...
public class DotNetModifier {
	...
	public static final DotNetModifier PUBLIC = new DotNetModifier(PUBLIC_MOD,
			PUBLIC_KEY, false, 1);
	public static final DotNetModifier PRIVATE = new DotNetModifier(
			PRIVATE_MOD, PRIVATE_KEY, false, 1);
	public static final DotNetModifier PROTECTED = new DotNetModifier(
			PROTECTED_MOD, PROTECTED_KEY, false, 1);
	public static final DotNetModifier INTERNAL = new DotNetModifier(
			INTERNAL_MOD, INTERNAL_KEY, true, 2);
	public static final DotNetModifier ABSTRACT = new DotNetModifier(
			ABSTRACT_MOD, ABSTRACT_KEY, false, 3);
	public static final DotNetModifier STATIC = new DotNetModifier(STATIC_MOD,
			STATIC_KEY, false, 3);
	public static final DotNetModifier SEALED = new DotNetModifier(SEALED_MOD,
			SEALED_KEY, true, 3);
	public static final DotNetModifier VIRTUAL = new DotNetModifier(
			VIRTUAL_MOD, VIRTUAL_KEY, true, 4);
	public static final DotNetModifier OVERRIDE = new DotNetModifier(
			OVERRIDE_MOD, OVERRIDE_KEY, true, 4);
	public static final DotNetModifier NEW = new DotNetModifier(NEW_MOD,
			NEW_KEY, true, 4);
	public static final DotNetModifier PARTIAL = new DotNetModifier(
			PARTIAL_MOD, PARTIAL_KEY, true, 5);
	public static final DotNetModifier READONLY = new DotNetModifier(
			READONLY_MOD, READONLY_KEY, true, 5);
	public static final DotNetModifier CONST = new DotNetModifier(CONST_MOD,
			CONST_KEY, true, 5);
	public static final DotNetModifier FINAL = new DotNetModifier(FINAL_MOD,
			FINAL_KEY, false, 2);
	public static final DotNetModifier STRICTFP = new DotNetModifier(
			STRICTFP_MOD, STRICTFP_KEY, false, 1);
	...
	protected DotNetModifier(int kind, String keyword, boolean dotnetonly,
			int height) {
		this.kind = kind;
		this.height = height;
