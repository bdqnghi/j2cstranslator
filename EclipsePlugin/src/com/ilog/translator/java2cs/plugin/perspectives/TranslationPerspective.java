 ...
 *******************************************************************************/
package com.ilog.translator.java2cs.plugin.perspectives;
 ...
 * change.
 */
public class TranslationPerspective implements IPerspectiveFactory {
	...
	private void addViews() {
		...
		final IFolderLayout bottom = factory.createFolder("bottomRight", // NON-NLS-1
				IPageLayout.BOTTOM, 0.75f, factory.getEditorArea());
		bottom.addView(IPageLayout.ID_PROBLEM_VIEW);
		bottom.addView("org.eclipse.team.ui.GenericHistoryView"); // NON-NLS-1
		bottom.addPlaceholder(IConsoleConstants.ID_CONSOLE_VIEW);

		final IFolderLayout topLeft = factory.createFolder("topLeft", // NON-NLS-1
