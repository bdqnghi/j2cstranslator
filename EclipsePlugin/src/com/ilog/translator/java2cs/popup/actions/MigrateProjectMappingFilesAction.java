...
public class MigrateProjectMappingFilesAction extends ActionDelegate implements
	 ...
	 */
	public MigrateProjectMappingFilesAction() {
		super();
	}
	...
	private static void migrateMappingFiles(IJavaProject javaProject,
		...
		model.migrateProjectMappingFiles();
	}
