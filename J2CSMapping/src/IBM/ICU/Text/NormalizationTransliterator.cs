	...
	internal sealed class NormalizationTransliterator : Transliterator {
	    ...
	    public sealed class Anonymous_C3 : Transliterator.Factory {
	        public Transliterator GetInstance(String ID) {
	            return IBM.ICU.Text.NormalizationTransliterator.GetInstance(IBM.ICU.Text.Normalizer.NFC);
	        }
	    }
	
	    public sealed class Anonymous_C2 : Transliterator.Factory {
	        public Transliterator GetInstance(String ID) {
	            return IBM.ICU.Text.NormalizationTransliterator.GetInstance(IBM.ICU.Text.Normalizer.NFD);
	        }
	    }
	
	    public sealed class Anonymous_C1 : Transliterator.Factory {
	        public Transliterator GetInstance(String ID) {
	            return IBM.ICU.Text.NormalizationTransliterator
	                    .GetInstance(IBM.ICU.Text.Normalizer.NFKC);
	        }
	    }
	    ...
	    public sealed class Anonymous_C0 : Transliterator.Factory {
	        public Transliterator GetInstance(String ID) {
	            return IBM.ICU.Text.NormalizationTransliterator
	                    .GetInstance(IBM.ICU.Text.Normalizer.NFKD);
	        }
	    }
	    ...
	    /// <summary>
	    /// The set of "unsafe start" characters. These are characters with cc==0 but
	    /// which may interact with previous characters. We effectively consider
	    /// these to be cc!=0, for our purposes.
	    /// From http://www.macchiato.com/utc/NFUnsafeStart-3.1.1dX.txt Generated in
	    /// unicodetools, NFSkippable
	    /// </summary>
	    ///
	
	    static internal readonly UnicodeSet[] UNSAFE_STARTS = new UnicodeSet[4];
	
	    static internal readonly UnicodeSet[] SKIPPABLES = new UnicodeSet[4];
	
	    internal const int D = 0, C = 1, KD = 2, KC = 3;
	
	    // Instance data, simply pointer to one of the sets below
	    internal readonly UnicodeSet unsafeStart;
	
	    internal readonly UnicodeSet skippable;
	    ...
	    static internal void Register() {
	        IBM.ICU.Text.Transliterator.RegisterFactory("Any-NFC", new NormalizationTransliterator.Anonymous_C3 ());
	        IBM.ICU.Text.Transliterator.RegisterFactory("Any-NFD", new NormalizationTransliterator.Anonymous_C2 ());
	        IBM.ICU.Text.Transliterator.RegisterFactory("Any-NFKC",
	                new NormalizationTransliterator.Anonymous_C1 ());
	        IBM.ICU.Text.Transliterator.RegisterFactory("Any-NFKD",
	                new NormalizationTransliterator.Anonymous_C0 ());
	        IBM.ICU.Text.Transliterator.RegisterSpecialInverse("NFC", "NFD", true);
	        IBM.ICU.Text.Transliterator.RegisterSpecialInverse("NFKC", "NFKD", true);
	    }
	    ...
	    /// <summary>
	    /// Initialize statics for the given mode. This is slow, so we defer it.
	    /// </summary>
	    ///
	    private static void InitStatics(int startChoice) {
	        switch (startChoice) {
	        case D:
	        ...
	        case C:
	            ...
	            break;
	        case KD:
	            UNSAFE_STARTS[KD] = new UnicodeSet(
	                    "[\u0F73\u0F75\u0F81\uFF9E-\uFF9F]", false);
