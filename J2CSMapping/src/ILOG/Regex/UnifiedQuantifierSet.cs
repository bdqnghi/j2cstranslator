...
// --------------------------------------------------------------------------------------------------
 namespace ILOG.J2CsMapping.RegEx {
	...
	/// </summary>
	///
	internal class UnifiedQuantifierSet : LeafQuantifierSet {
	
		public UnifiedQuantifierSet(LeafSet innerSet, AbstractSet next, int type) : base(innerSet, next, type) {
		}
	
		public UnifiedQuantifierSet(LeafQuantifierSet quant) : base((LeafSet)quant.GetInnerSet(), quant.GetNext(), quant.GetType()) {
