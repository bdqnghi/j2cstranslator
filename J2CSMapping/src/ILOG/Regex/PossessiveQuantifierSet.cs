...
// --------------------------------------------------------------------------------------------------
 namespace ILOG.J2CsMapping.RegEx {
	...
	/// </summary>
	///
	internal class PossessiveQuantifierSet : LeafQuantifierSet {
	
		public PossessiveQuantifierSet(LeafSet innerSet, AbstractSet next, int type) : base(innerSet, next, type) {
		}
